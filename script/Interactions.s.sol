...
contract FundSubscription is Script, CodeConstants  {
    ...
    function fundSubscription(address vrfCoordinatorV2_5, uint256 subscriptionId, address linkToken) public {
        ...
        console.log("Funding subscription with vrfCoordinator"  , vrfCoordinatorV2_5);
...
contract AddConsumer is Script{
    ...
    function addConsumer(address consumer, address vrfCoordinatorV2_5, uint256 subscriptionId ) public {
        console.log("Adding consumer contract:"  , consumer);
        console.log("To vrfCoordinator:"  , vrfCoordinatorV2_5);
        console.log("on chain id:"  , block.chainid);
        
        vm.startBroadcast();
        VRFCoordinatorV2_5Mock(vrfCoordinatorV2_5).addConsumer(subscriptionId, consumer);
        vm.stopBroadcast();
    }

    function run() public {
        address mostRecentDeployed = DevOpsTools.get_most_recent_deployment("YoyoNft", block.chainid);
